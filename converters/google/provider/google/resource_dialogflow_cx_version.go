...
Format: projects/{{project_id}}/locations/{{location}}/agents/{{agent_id}}/flows/{{flow_id}}`,
			...
			"name": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: `Format: projects/{{project_id}}/locations/{{location}}/agents/{{agent_id}}/flows/{{flow_id}}/versions/{{version}}. Version is a self-increasing number generated by Dialogflow upon version creation.`,
			},
			"nlu_settings": {
