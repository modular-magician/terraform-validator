...
func ResourceConverters() map[string][]ResourceConverter {
	return map[string][]ResourceConverter{
		...
		"google_beyondcorp_app_gateway_iam_policy":                {resourceConverterBeyondcorpAppGatewayIamPolicy()},
		"google_beyondcorp_app_gateway_iam_binding":               {resourceConverterBeyondcorpAppGatewayIamBinding()},
		"google_beyondcorp_app_gateway_iam_member":                {resourceConverterBeyondcorpAppGatewayIamMember()},
