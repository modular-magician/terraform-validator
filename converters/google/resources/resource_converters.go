...
func ResourceConverters() map[string][]ResourceConverter {
	return map[string][]ResourceConverter{
		...
		"google_beyondcorp_app_connector_iam_policy":              {resourceConverterBeyondcorpAppConnectorIamPolicy()},
		"google_beyondcorp_app_connector_iam_binding":             {resourceConverterBeyondcorpAppConnectorIamBinding()},
		"google_beyondcorp_app_connector_iam_member":              {resourceConverterBeyondcorpAppConnectorIamMember()},
