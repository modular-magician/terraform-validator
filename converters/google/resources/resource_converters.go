...
func ResourceConverters() map[string][]ResourceConverter {
	return map[string][]ResourceConverter{
		...
		"google_active_directory_domain_iam_policy":               {resourceConverterActiveDirectoryDomainIamPolicy()},
		"google_active_directory_domain_iam_binding":              {resourceConverterActiveDirectoryDomainIamBinding()},
		"google_active_directory_domain_iam_member":               {resourceConverterActiveDirectoryDomainIamMember()},
