...
func ResourceConverters() map[string][]ResourceConverter {
	return map[string][]ResourceConverter{
		...
		"google_data_catalog_taxonomy_iam_policy":                 {resourceConverterDataCatalogTaxonomyIamPolicy()},
		"google_data_catalog_taxonomy_iam_binding":                {resourceConverterDataCatalogTaxonomyIamBinding()},
		"google_data_catalog_taxonomy_iam_member":                 {resourceConverterDataCatalogTaxonomyIamMember()},
		"google_data_catalog_policy_tag_iam_policy":               {resourceConverterDataCatalogPolicyTagIamPolicy()},
		"google_data_catalog_policy_tag_iam_binding":              {resourceConverterDataCatalogPolicyTagIamBinding()},
		"google_data_catalog_policy_tag_iam_member":               {resourceConverterDataCatalogPolicyTagIamMember()},
