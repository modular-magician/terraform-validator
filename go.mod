...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220224191253-5e61d2b2f5cc
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220224231743-771e4b29a4fd
