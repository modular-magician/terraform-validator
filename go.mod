...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20230303001006-fccd02b0aeb0
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20230303011932-0a0970cd00d3
