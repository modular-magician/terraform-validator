...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20230104171638-acbb832d2e3c
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20230104191806-4f45d9adf042
