...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20230405170232-1594361d6fba
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20230405190807-270510ac9b2a
