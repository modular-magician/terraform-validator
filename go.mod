...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20230109203826-0f9e1ef5a7e2
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20230109223609-cacd735df2ab
