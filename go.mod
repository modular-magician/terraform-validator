...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220310201235-d2d3b2233837
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220310201813-3f78a856daad
