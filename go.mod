...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220330212615-122dbb1fc3b7
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220330212615-122dbb1fc3b7
