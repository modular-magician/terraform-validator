...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220407215943-0a74225acb43
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220407223809-d3a99911feea
