...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220321183932-2d7825f07326
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220321202642-f22fb0b3e6cc
