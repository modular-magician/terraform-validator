...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220622215010-b1eb7908cd98
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220622215010-b1eb7908cd98
