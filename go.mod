...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220322224258-a5e708f93d1a
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220323181032-ffbfec5eb662
