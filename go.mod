...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220913214046-53f6251f5e16
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220915061218-debe0ea1d4ca
