...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220721005449-d7e050df14d6
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220721133523-50582a88732b
