...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220715174057-182ace8dfde9
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220715174057-182ace8dfde9
