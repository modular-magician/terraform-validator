...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220217183126-cbbc307b7dae
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220217183126-cbbc307b7dae
