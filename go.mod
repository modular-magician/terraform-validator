...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220610162216-b5cd00f96a06
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220610162216-b5cd00f96a06
