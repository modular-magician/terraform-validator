...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220328161823-1a3e5b9a19a3
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220328161823-1a3e5b9a19a3
