...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220317163019-7b9d5ade746d
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220317163019-7b9d5ade746d
