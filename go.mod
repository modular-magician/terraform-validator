...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220509193607-8fa4d0199940
...
replace github.com/hashicorp/terraform-provider-google => github.com/modular-magician/terraform-provider-google v1.20.1-0.20220510102713-765db7a09cdc
